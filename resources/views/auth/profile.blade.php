            ...
            <div class="row">
                <div class="ac-layout pb-5">
                    ...
                    <ul class="navbar-nav ac-navbar">
                        ...
                        <li class="nav-item active"><a href="/edit-profile" class="nav-link"><span class="material-symbols-outlined">person</span>Edit Account</a></li>
                    ...
                    <div class="ac-title">
                        ...
                        <h1 class="fs-5">My Account Information</h1>
                    </div>
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="multiple-form-group">
                            <div class="form-group required">
                                <label for="input-firstname">First Name </label>
                                <input type="text" name="firstname" value="Jibon" placeholder="First Name" id="input-firstname" class="form-control shadow-none">
                            </div>
                            <div class="form-group required">
                                <label for="input-lastname">Last Name</label>
                                <input type="text" name="lastname" value="Sutradhar" placeholder="Last Name" id="input-lastname" class="form-control shadow-none">
                            </div>
                        </div>
                        <div class="form-group required">
                            <label for="input-email">E-Mail</label>
                            <input type="email" name="email" value="example@gmail.com" placeholder="E-Mail" readonly="" id="input-email" class="form-control shadow-none">
                        </div>
                        <div class="form-group required">
                            <label for="input-telephone">Telephone</label>
                            <input type="tel" name="telephone" value="" placeholder="Telephone" readonly="" id="input-telephone" class="form-control shadow-none">
                        </div>
                        <div class="form-group">
                            <label for="input-fax">Fax</label>
                            <input type="text" name="fax" value="" placeholder="Fax" id="input-fax" class="form-control shadow-none">
                        </div>
