...
headers.value =  [
          ...
          { field: 'title', title: 'Offer Name' },
          { field: 'thumbnail', title: 'Offer Image', },
          { field: 'description', title: 'Offer Description'},
...
function editValue(data){
  window.location.href = window.location.origin + '/offer/edit/'+ data.id
}
function deleteValue(data){
  window.location.href = window.location.origin + '/offer/delete/'+ data.id
}
